...
{
#ifdef _WIN32
	"Cross-Assembler 65xx V" TOOL_VERSION_STRING " (" __TIME__ " / " __DATE__ ") \r\n"
#else
	"Cross-Assembler 65xx V" TOOL_VERSION_STRING " (No date available) \r\n"
#endif
...
static char *ertxt[] =
{
	...
	"NewLine",
	"NewFile",
	"CMOS instructions are not allowed (-C flag)",
